...
const BackgroundWelcomePillarsView: React.FC = () => {
    return (
        <>
            <svg className="welcome-pillar-image" width="885" height="437" viewBox="0 0 885 437" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M812.827 18L884.89 54V385L812.827 349V18Z" fill="url(#pillar0_linear)" fillOpacity="0.9" />
                <path d="M447.51 38L519.573 74V405L447.51 369V38Z" fill="url(#pillar1_linear)" fillOpacity="0.9" />
                <path d="M715.743 90L679.712 109V437L715.743 416V90Z" fill="url(#pillar2_linear)" fillOpacity="0.9" />
                <path d="M168.268 18L132.237 37V365L168.268 344V18Z" fill="url(#pillar3_linear)" fillOpacity="0.9" />
...
export default BackgroundWelcomePillarsView;