...
const BackdropWelcomeMountainView: React.FC = () => {
    return (
        <>
            <svg className="welcome-backdrop-mountain__image" viewBox="0 0 1150 547" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="welcome-backdrop-mountain-mobile__image" viewBox="0 0 375 1415" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M-1 8.88097C-1 148.177 376.13 104.07 376 8.88097C375.87 -86.3079 380 1415 380 1415H-1C-1 1415 -1 -130.415 -1 8.88097Z" fill="url(#welcome-backdrop-mountain-mobile-paint0_linear)" />
                <defs>
                    <linearGradient id="welcome-backdrop-mountain-mobile-paint0_linear" x1="189.001" y1="1415" x2="189" y2="-97.5104" gradientUnits="userSpaceOnUse">
