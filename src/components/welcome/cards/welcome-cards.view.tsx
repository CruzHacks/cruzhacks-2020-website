            ...
            <div className="welcome-card__text">
                ...
                <svg className="welcome-card__tree" width="81" height="125" viewBox="0 0 81 125" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#tree_clip0)">
                        ...
                        <path d="M72.6281 68.5376L45.2685 54.7103C42.0523 53.0843 38.2548 53.0906 35.045 54.7229L7.6854 68.6384C4.22912 70.3968 4.23544 75.3252 7.69804 77.0709L34.5585 90.6461C38.0779 92.4233 42.2419 92.4296 45.7677 90.6587L72.6281 77.1717C76.1728 75.3882 76.1792 70.3274 72.6281 68.5376Z" fill="url(#tree1_linear)" />
                ...
                <p className="welcome-card__caption">{t.text}</p>
            </div>
        </div>
    );
});
