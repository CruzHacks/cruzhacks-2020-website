...
const HeroLightBulbView: React.FC = () => {
  return (
    <div className="hero__lightbulb">
      ...
      >
<<<<<<< HEAD
        <g clipPath="url(#hero-lightbulb__clip0)">
          <path
            opacity=".13"
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <path
            ...
            stroke="url(#hero-lightbulb-paint0__linear)"
            strokeWidth="1.5"
            strokeLinecap="round"
          ...
          <path
            ...
            stroke="url(#hero-lightbulb-paint1__linear)"
            strokeWidth="1.5"
            strokeMiterlimit="10"
          />
          <mask
          ...
          <g mask="url(#a)">
            <path
              ...
              fill="url(#hero-lightbulb-paint2__linear)"
              stroke="url(#hero-lightbulb-paint3__linear)"
              strokeWidth=".75"
              strokeMiterlimit="10"
            />
            <path
              ...
              stroke="url(#hero-lightbulb-paint4__linear)"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
        ...
        <defs>
          <linearGradient
            id="hero-lightbulb-paint0__linear"
            x1="13.256"
            y1="27.048"
            x2="22.575"
            y2="27.048"
          ...
          <linearGradient
            id="hero-lightbulb-paint1__linear"
            x1="6.803"
            y1="12.222"
            x2="29.351"
            y2="12.222"
          ...
          <linearGradient
            id="hero-lightbulb-paint2__linear"
            x1="17.321"
            y1="19.038"
            x2="18.671"
            y2="19.038"
          ...
          <linearGradient
            id="hero-lightbulb-paint3__linear"
            x1="17.156"
            y1="19.038"
            x2="18.836"
            y2="19.038"
          ...
          <linearGradient
            id="hero-lightbulb-paint4__linear"
            x1="18.079"
            y1="34.294"
            x2="18.079"
            y2="-.414"
          ...
          <clipPath id="hero-lightbulb__clip0">
            <path fill="#fff" d="M0 0h36v30H0z" />
          </clipPath>
=======
        <path fill="url(#pattern0)" d="M0 0h55v48H0z" />
        <defs>
          <pattern
            id="pattern0"
