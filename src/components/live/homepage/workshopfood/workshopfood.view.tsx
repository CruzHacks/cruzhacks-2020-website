...
const WorkshopFoodView: React.FC = () => {
    ...
    const classNameForToggle = `workshop-and-food__toggle-component ${isToggleActive ? 'active' : ''}`;
        ...
        <div className="workshop-and-food__container">
            <div className="workshop-and-food__card">
                <div className="workshop-and-food__toggle-buttons-container">
                    ...
                    >
                        <div className="workshop-and-food__toggle-button"></div>
                        {
                            isToggleActive
                            ? <span className="workshop-and-food__workshop-toggle">Workshop</span> 
                ...
                <div className="workshop-and-food__day-button-container">
                    <div className="workshop-and-food__day-one-container">
                        <button 
                            className={`workshop-and-food__day-button-one ${isDayOne ? 'active' : ''}`} 
                   ...
                   <div className="workshop-and-food__day-two-container">
                       <button 
                            className={`workshop-and-food__day-button-two ${isDayTwo ? 'active' : ''}`} 
                   ...
                   <div className="workshop-and-food__day-three-container">
                       <button 
                            className={`workshop-and-food__day-button-three ${isDayThree ? 'active' : ''}`} 
